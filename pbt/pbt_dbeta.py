...
from configs.pbt.dbeta_vae_pbt import get_config
...
if __name__ == '__main__':
    ...
    def explore(config):
        ...
        config["C"] = np.clip(config["C"], 1, 25)
        return config
    ...
    tuner = tune.Tuner(
        ...
        run_config=air.RunConfig(
            ...
            local_dir='/data/PycharmProjects/cytof_benchmark/logs/ray_tune/DBeta_VAE',
            name="dbvae_training",
    ...
    torch.save(best_result.checkpoint.to_dict(), '/data/PycharmProjects/cytof_benchmark/logs/ray_tune/DBeta_VAE/Dis_Beta_VAE_big.pth')
    with open('/data/PycharmProjects/cytof_benchmark/logs/ray_tune/DBeta_VAE/Dis_Beta_VAE_big_summary.txt', 'w') as f:
